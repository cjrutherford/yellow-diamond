            ...
            <Form className="container" style={{
                ...
                gridSpacing: '1em',
                  ...
                  <InputGroup>
                    ...
                    <Input name='appDescription' type='textarea' onChange={this.onChange} />
                  </InputGroup>
...
<InputGroup></InputGroup>
                  ...
                  <InputGroup>
                    <img src={this.state.appIcon} alt="application icon" className='img-thumbnail'/>
                  </InputGroup>
                  ...
                  <InputGroup>
                    <img src={this.state.appBanner} alt="applcaion banner" className='img-thumbnail' />
                  </InputGroup>
                  <InputGroup>
                    <Button onClick={this.resetForm} className='warn'>Reset</Button>
                    <Button onClick={this.submitForm} className='primary'>Submit</Button>
                  </InputGroup>
            </Form>
        );
    }
